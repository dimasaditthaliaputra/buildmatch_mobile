...
class ArchitectProjectRequestModel extends ArchitectProjectRequestEntity {
  ...
  factory ArchitectProjectRequestModel.fromJson(Map<String, dynamic> json) {
    return ArchitectProjectRequestModel(
