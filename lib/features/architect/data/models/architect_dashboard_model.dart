...
class ArchitectDashboardModel extends ArchitectDashboardEntity {
  const ArchitectDashboardModel({
    required super.architectName,
    required super.architecRole,
    super.avatarUrl,
  ...
  factory ArchitectDashboardModel.fromJson(Map<String, dynamic> json) {
    return ArchitectDashboardModel(
      architectName: json['contractor_name'] ?? '',
      architecRole: json['contractor_role'] ?? '',
