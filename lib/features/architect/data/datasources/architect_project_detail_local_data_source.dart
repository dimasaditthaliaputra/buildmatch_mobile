...
abstract class ArchitectProjectDetailLocalDataSource {
  ArchitectProjectDetailEntity getArchitectProjectDetail(String id);
}

class ArchitectProjectDetailLocalDataSourceImpl implements ArchitectProjectDetailLocalDataSource {
  @override
  ArchitectProjectDetailEntity getArchitectProjectDetail(String id) {
    final Map<String, ArchitectProjectDetailEntity> details = {
      '1': const ArchitectProjectDetailEntity(
        id: '1',
      ...
      '2': const ArchitectProjectDetailEntity(
        id: '2',
      ...
      '3': const ArchitectProjectDetailEntity(
        id: '3',
        title: 'Creative Hub Office Expansion',
        category: 'RESIDENSIAL',
        location: 'BSD',
