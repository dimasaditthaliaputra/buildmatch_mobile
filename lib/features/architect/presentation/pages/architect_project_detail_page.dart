import 'package:buildmatch_mobile/features/architect/domain/entities/Architect_project_detail_entity.dart';
...
import '../bloc/architect_project_detail_bloc.dart';
import '../bloc/architect_project_detail_event.dart';
import '../bloc/architect_project_detail_state.dart';

import '../widgets/project/detail_row.dart';
import '../widgets/project/insight_item.dart';

class ArchitectProjectDetailPage extends StatelessWidget {
  final String projectId;

  const ArchitectProjectDetailPage({super.key, required this.projectId});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => sl<ArchitectProjectDetailBloc>()..add(LoadArchitectProjectDetail(projectId)),
      child: const _ArchitectProjectDetailPage(),
    );
  }
}

class _ArchitectProjectDetailPage extends StatelessWidget {
  const _ArchitectProjectDetailPage();

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<ArchitectProjectDetailBloc, ArchitectProjectDetailState>(
      builder: (context, state) {
        ...
        return _ArchitectProjectDetailContent(project: state.project!);
      },
    );
  }
}

class _ArchitectProjectDetailContent extends StatelessWidget {
  final ArchitectProjectDetailEntity project;

  const _ArchitectProjectDetailContent({required this.project});
