...
import 'package:buildmatch_mobile/core/utils/idr_formatter.dart';
...
class ArchitectSystemMilestoneCard extends StatelessWidget {
  final ArchitectMilestoneEntity milestone;
  final ValueChanged<DateTime> onDeadlineChanged;
  final bool isDisabled;

  const ArchitectSystemMilestoneCard({
    super.key,
