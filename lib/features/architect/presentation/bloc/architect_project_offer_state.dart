...
class ArchitectProjectOfferState extends Equatable {
  final int? budgetMin;
  final int? budgetMax;
  final String pesan;
  ...
  const ArchitectProjectOfferState({
    this.budgetMin,
    this.budgetMax,
    this.pesan = '',
    this.estimasiWaktu,
  ...
  factory ArchitectProjectOfferState.initial() => const ArchitectProjectOfferState();

  ArchitectProjectOfferState copyWith({
    int? budgetMin,
    int? budgetMax,
    String? pesan,
    ...
    return ArchitectProjectOfferState(
