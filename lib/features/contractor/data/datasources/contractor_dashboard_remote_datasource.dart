import '../models/contractor_dashboard_model.dart';

abstract class ContractorDashboardRemoteDataSource {
  Future<ContractorDashboardModel> getDashboardData(String contractorId);
}

class ContractorDashboardRemoteDataSourceImpl
    implements ContractorDashboardRemoteDataSource {
  // Inject Supabase client here in real implementation
  // final SupabaseClient supabaseClient;

  @override
  Future<ContractorDashboardModel> getDashboardData(
    String contractorId,
  ) async {
    // Replace with actual Supabase call:
    // final response = await supabaseClient
    //     .from('contractor_dashboard')
    //     .select('*')
    ...
    return ContractorDashboardModel.fromJson(_mockData);
  }

  static const Map<String, dynamic> _mockData = {
    'contractor_name': 'UrbanCore',
    'contractor_role': 'buildkedu',
    'avatar_url': null,
    'financial_summary': {
